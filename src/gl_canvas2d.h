...
public:
    ...
    static void point(dvec2 pos); //coordeandas do ponto

    static void line(float x1, float y1, float x2, float y2); //coordenadas da linha x1, y1, x2, y2
    static void line(dvec2 p1, dvec2 p2); //coordenadas da linha (p1, p2)
    ...
    static void rect(dvec2 p1, dvec2 p2); //coordenadas do retangulo (p1, p2) - TO DO

    static void rectFill(float x1, float y1, float x2, float y2); //coordenadas do retangulo x1, y1, x2, y2
    static void rectFill(dvec2 p1, dvec2 p2); //coordenadas do retangulo (p1, p2)
    ...
    static void circle(dvec2 pos, float radius, int div);

    static void circleFill(float x, float y, float radius, int div);

    static void circleFill(dvec2 pos, float radius, int div);
    ...
    static void text(dvec2 pos, const char *t);
