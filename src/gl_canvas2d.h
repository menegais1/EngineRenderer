...
public:
    ...
    static void line(fvec2 p1, fvec2 p2); //coordenadas da linha (p1, p2)
    ...
    static void rect(fvec2 p1, fvec2 p2); //coordenadas do retangulo (p1, p2) - TO DO
    ...
    static void circle(fvec2 pos, float radius, int div);
    ...
    static void text(fvec2 pos, const char *t);

    //coordenada de offset para desenho de objetos.
    static void translate(float x, float y);

    static void translate(fvec2 pos);
    ...
    static void color(fvec4 color);
    static void color(fvec3 color);

    static void setClearColor(fvec4 color);
};
