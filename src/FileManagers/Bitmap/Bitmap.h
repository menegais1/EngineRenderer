...
public:
    ...
    fvec4 sampleBitmao(const float u, const float v) const;

    fvec4 getPixelColorAtPosition(const int l, const int c) const;

    fvec2 getPixelPositionOnScreen(const int l, const int c) const;
...
private:
    ...
    fvec4 getPixelFromPallete(const unsigned char pixelValue);
